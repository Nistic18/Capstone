        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-lg" style="border-radius: 20px;">
                ...
                <div class="card-body p-5">
                    {{-- Back Button --}}
                    <div class="mb-4">
                        <a href="{{ route('newsfeed.index') }}" class="btn btn-outline-secondary">
                            <i class="fas fa-arrow-left me-2"></i>Back to Newsfeed
                        </a>
                    </div>

                    {{-- Edit Form --}}
                    <form method="POST" action="{{ route('newsfeed.update', $post) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between flex-wrap gap-3">
                            <a href="{{ route('newsfeed.index') }}" class="btn btn-secondary btn-lg px-4"
