...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Ban and Restrict Routes (NEW - replaces destroy)
    Route::post('/users/{user}/restrict', [UserController::class, 'restrictUser'])->name('users.restrict');
...
// IMPORTANT: Specific profile routes MUST come BEFORE dynamic {user} route
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/buyer/reports/download/purchases', [BuyerReportsController::class, 'downloadPurchaseReport'])
        ->name('buyer.reports.download.purchases');
    
    Route::get('/buyer/reports/download/spending', [BuyerReportsController::class, 'downloadSpendingReport'])
        ->name('buyer.reports.download.spending');
    
    Route::get('/buyer/reports/download/reviews', [BuyerReportsController::class, 'downloadReviewsReport'])
